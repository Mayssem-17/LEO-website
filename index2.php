      ...
      <div class="row">
        <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
          <p class="text2"><span class="text5">Test your English level</span><br /><br /> This test contains grammar and
            ...
            <!-- <br/><br/> <button type="button" onclick="location.href='../project/link2.html'" class="button6">Take Level Test</button></p>     -->
...
<div class="container reveal">
  ...
  <div class="cards">
    <div class="text-card"  style="box-shadow: 2px 2px 10px 3px #7c7672;background-color:#d0ff77;">
      ...
      <p style="font-size: 18px ; color:#000b1e; text-align:center">Build a strong language base with our comprehensive Beginner English Course.</p>
    </div>
    ...
    <div class="cards">
      <div class="text-card" style="box-shadow: 2px 2px 10px 2px #7c7672;background-color:#07a5ff;">
        ...
        <p style="font-size: 18px ; color:#000b1e; text-align:center">Take your English skills to the next level with our Intermediate English Course!</p>
      </div>

      <div class="cards">
        <div class="text-card" style="box-shadow: 2px 2px 10px 2px #7c7672;background-color:#e5a500;">
          <h2>Advanced Course</h2>
          <p style="font-size: 18px ; color:#000b1e; text-align:center">Elevate your English proficiency to an advanced level with our Advanced English Course! </p>
        </div>
      </div>
</section>
      ...
      <div class="row">
        <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
          ...
          <p class="text2">That's why we have English texts for YOU to practice reading , Listening and comprehension
            online and for free.
            <!-- <br/><br/><button type="button" onclick="location.href='../project/link4.html'" class="button7">Let's GO</button></p> -->
        </div>
  ...
  <div class="container">
    ...
    <form method="POST" action="contact.php"> 
      <div class="row">
        ...
        <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12"> 
          <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12"> 
            <input type="submit" value="Send Message" class="button3">
          </div>
        </div>
      </div>
    </form>
